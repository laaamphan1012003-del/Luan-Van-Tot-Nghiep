...
const mysql = require('mysql2/promise'); // Dùng thư viện mysql2 chế độ promise

// 1. CẤU HÌNH DATABASE (Điền thông tin DB của bạn vào đây)
const DB_CONFIG = {
    host: 'localhost',
...
async function main() {
    ...
    try {
        ...
        // (Giả sử bảng của bạn tên là 'charge_points' và cột ID là 'charge_point_id')
        ...
        // Đặt tên sheet trùng với bảng tag bạn muốn paste vào (ví dụ 'Default Tag Table')
